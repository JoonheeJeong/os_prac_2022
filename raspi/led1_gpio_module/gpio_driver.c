...
// call inserting the module
static int __init gpio_init(void);

// call removing the module
static void __exit gpio_exit(void);

// call opening the device driver file
static int gpio_open(struct inode *inode, struct file *filp);

// call closing the device driver file
static int gpio_release(struct inode *inode, struct file *filp);

// call reading the device driver file
static ssize_t gpio_read(struct file *filp, 
						 char *buf, size_t len, loff_t *off);

// call writing the device driver file
static ssize_t gpio_write(struct file *filp,
						 const char *buf, size_t len, loff_t *off);

// connect file operations of the device driver to the functions above
